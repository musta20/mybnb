import{L as d}from"./index-HckQbaeO.js";var r={};const p={},o=new d({apiKey:r.GOOGLE_MAPS_API_KEY,version:"weekly",...p});o.load().then(async()=>{const{AdvancedMarkerElement:a,PinElement:g}=await google.maps.importLibrary("marker"),l=new google.maps.Map(document.getElementById("map"),{zoom:13,center:{lat:search.city.lat,lng:search.city.lng},mapId:"DEMO_MAP_ID"});for(const e of locations){const t=new a({map:l,content:i(e),position:{lat:Number(e.latitude),lng:Number(e.longitude)},title:e.title});t.addListener("click",()=>{n(t)})}function n(e,t){const s=e.content.querySelector("#price-tag");e.content.classList.contains("highlight")?(s.classList.remove("hide-tag"),e.content.classList.remove("highlight"),e.zIndex=null):(e.content.classList.add("highlight"),s.classList.add("hide-tag"),e.zIndex=1)}function i(e){const t=document.createElement("div");let s;return e.media[0].path?s=`<image class='min-w-[350px] w-full max-h-[200px]' src='http://localhost/listings/${e.media[0].path}'>`:s="<span class='text-gray-900 m-auto w-24 dark:text-gray-100'>No image</span>",t.classList.add("property"),t.innerHTML=`
        <div  class=" px-4 py-2 ">
