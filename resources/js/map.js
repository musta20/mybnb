...
async function initMap() {
    ...
    function buildContent(location) {
        ...
        if(location.media[0].path){
            Imageurl = `<image class=' ' width='250px' src='${mainUrl}/listings/${location.media[0].path}'>`;
        }else{
        ...
        <div id="price-tag" class="price-tag">
            ...
            <div>
                ...
                <div class="p-2 flex  justify-between align-baseline text-xs ">
                    ...
                    <a href="${mainUrl}/listing/${location.id}" class="border w-full   text-gray-900 dark:text-gray-100">
                       <p>
                        ${ location.title}
                        </p>   
