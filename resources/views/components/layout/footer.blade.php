<footer class="bg-[#f3f3f3] justify-between p-5 px-10 text-[#172a36]   h-96 ">
  ...
  <div class="flex text-[#195072] flex-col gap-1 text-center">
    ...
    <div class="flex flex-col text-sm mt-3 font-Mada   text-primary gap-2">
      <a href="#" class="text-sm text-secondary ">مركز المساعدة</a>
  ...
  <div class="flex text-[#195072] flex-col gap-1 text-center">
    <p class="text-md font-bold"> الشركة</p>
    <div class="flex flex-col text-sm mt-3 font-Mada   text-primary gap-2">
      <a href="#" class="text-sm text-secondary ">من نحن</a>
      <a href="#" class=" text-secondary ">المدونة</a>
      <a href="#" class="  text-secondary ">الوظائف</a>
  ...
  <div class="flex text-[#195072] flex-col gap-1 text-center">
    <p class="text-md font-bold"> تواصل</p>
    <div class="flex flex-col text-sm mt-3 font-Mada   text-primary gap-2">
      <a href="#" class="text-sm text-secondary ">الشراكة</a>
  ...
  <div class="flex text-[#195072] flex-col gap-1 text-center">
    <p class="text-md font-bold"> وسائل التواصل</p>
    <div class="flex  text-sm mt-3 font-Mada   text-primary gap-2">
  ...
  <hr>
<div class="w-1/2" >
  <p class="text-sm  p-5 text-secondary ">© 2022. جميع الحقوق محفوظة. </p>
</div>
</footer>