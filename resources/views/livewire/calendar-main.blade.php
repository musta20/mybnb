...
new class extends Component
{
   ...
   public function mount($events,$month=null,)
   {
...
?>
    ...
    <div class=" sans-serif">
        <div x-data="app()" x-init="[initDate($wire.month), getNoOfDays(),initEvents($wire.event)]" x-cloak>
                    ...
                    <div class="flex items-center justify-between py-2 px-6">
                        <div>
                            <span x-text="MONTH_NAMES[month]"
                                class="text-lg font-bold text-gray-800 dark:text-gray-300"></span>
                            <span x-text="year"
                                class="ml-1 text-lg text-gray-600 dark:text-gray-300 font-normal"></span>
                        </div>
                    ...
                    <div class="-mx-1 -mb-1">
                        ...
                        <div class="flex flex-wrap border-t border-l">
                            ...
                            <template x-for="(date, dateIndex) in no_of_days" :key="dateIndex">
                                <div style="width: 14.28%; height: 120px"
                                    class="px-4 pt-2 border-r border-b relative dark:text-white  dark:bg-gray-700">
                ...
                <div class="p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24">
                    ...
                    <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input
                                class="bg-gray-200 appearance-none border-2 border-gray-200 dark:border-gray-300 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500"
            ...
            function app() {
                return {
                    ...
                    initDate(month=null) {
                        ...
                        this.month = month ? month  : today.getMonth();
