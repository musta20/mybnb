<div class=" px-4 py-2 ">
    ...
    <div
        class="details bg-white hover:shadow-xl dark:hover:shadow-gray-700 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div>

            ${Imageurl}
            <div class="-mt-44 mx-2 absolute hover:text-slate-300   ">

                <svg fill="#f1f1f1" class="w-6 h-6  rounded-full" xmlns="http://www.w3.org/2000/svg" fill="none"
